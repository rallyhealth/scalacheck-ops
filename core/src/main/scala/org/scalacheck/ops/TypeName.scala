...
@implicitNotFound(
  "Could not grab the type name of $" + "{T} at compile-time... except for printing this error message (go figure). " + "This means that neither a ClassTag nor izumi.reflect.Tag could not be summoned for this type."
)
