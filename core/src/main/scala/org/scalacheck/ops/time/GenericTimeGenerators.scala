...
trait GenericTimeGenerators {
  ...
  def beforeNowWithin(maxRange: DurationType)(implicit params: ParamsType = defaultParams): Gen[InstantType]
  ...
  def afterNowWithin(maxRange: DurationType)(implicit params: ParamsType = defaultParams): Gen[InstantType]

  def around(
    when: InstantType,
    plusOrMinus: DurationType = defaultRange
  )(implicit
    params: ParamsType = defaultParams
  ): Gen[InstantType]
  ...
  def aroundNowWithin(plusOrMinus: DurationType)(implicit params: ParamsType = defaultParams): Gen[InstantType]
